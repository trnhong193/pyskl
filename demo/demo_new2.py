...
def main():
    ...
    # print(f'height: {h}')
    # print(f'width: {w}')
    # print(f'original_frames:{original_frames}')
    # print('\n')
    # print(f'original_frame - shape: {original_frames[0].shape}')
    ...
    print('\n')
    # print(f'det_results: {det_results[0]}')
    ...
    if GCN_flag:
        ...
        # print(o.attr for o in pose_results)
        print('55555555555555555555555')
        # print(pose_tracking(tracking_inputs, max_tracks=GCN_nperson))
