...
def parse_args():
    ...
    parser.add_argument(
        '--pose-config',
        default='/media/ivsr/newHDD1/pyskl/demo/pose.py',
        help='human pose estimation config file path (from mmpose)')
    parser.add_argument(
        '--pose-checkpoint',
        default='/media/ivsr/newHDD1/pyskl/demo/yoloxpose_s_8xb32-300e_coco-640-56c79c1f_20230829.pth',
...
# def dist_ske(ske1, ske2):
#     if ske1 is None or ske2 is None:
#         return float('inf')  # or any other value to indicate no match
