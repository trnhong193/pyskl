...
def read_data(file_path):
  """
  Parses a data file and returns data for the `fake_anno` dictionary.
...
def main():
    ...
    s1=timer()
    file_path = "/media/ivsr/data2/pyskl/demo/testfuck1111.txt"
    ...
    fake_anno['total_frames'] = keypoint.shape[1]
    s2=timer()
    
    print("time data:", s2-s1)
    # else:
    ...
    # ]
    # for i in range(num_frame):
    #     for frame in original_frames[i]:
