...
ann_file = '/media/ivsr/data2/pyskl/demo/results/ntu_small.pkl'
train_pipeline = [
...
# optimizer
optimizer = dict(type='SGD', lr=0.0001, momentum=0.9, weight_decay=0.0005, nesterov=True)
...
# runtime settings
log_level = 'INFO'
work_dir = './work_dirs/stgcn++/stgcn++_ntu60_xsub_hrnet/j'
